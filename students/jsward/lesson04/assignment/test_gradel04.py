"""
    Autograde Lesson 3 assignment (It's Lesson 4, actually)
    Run pytest
...
def test_populate_table_from_csv():
    """ populates table with 10,000 records """
    l.populate_table_from_csv('customer.csv')
    active_count = l.list_active_customers()
    assert active_count >= 6953
