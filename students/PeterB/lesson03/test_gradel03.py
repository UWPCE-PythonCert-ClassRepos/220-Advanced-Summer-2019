...
def _update_customer_credit(): # needs to del with database
    return [
        ("798", "Name", "Lastname", "homeaddress", "phone", "email", "active", 999),
        ("797", "Name", "Lastname", "homeaddress", "phone", "email", "inactive", 10),
        ("796", "Name", "Lastname", "homeaddress", "phone", "email", "inactive", -99)
    ]

@pytest.fixture
def _list_active_customers():
    return [
        ("598", "Name", "Lastname", "homeaddress", "phone", "email", "active", 999),
        ("597", "Name", "Lastname", "homeaddress", "phone", "email", "inactive", 10),
        ("596", "Name", "Lastname", "homeaddress", "phone", "email", "inactive", 99),
        ("595", "Name", "Lastname", "homeaddress", "phone", "email", "active", 999),
        ("594", "Name", "Lastname", "homeaddress", "phone", "email", "active", 10),
        ("593", "Name", "Lastname", "homeaddress", "phone", "email", "active", 99)
    ]
